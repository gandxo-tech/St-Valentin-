...
const IMAGES = {
    ...
    comfort: 'https://i.ibb.co/7tYKcLy0/unnamed-9.jpg',        // NOUVELLE
    sleep: 'https://i.ibb.co/GfBV1JKp/unnamed-11.jpg',         // NOUVELLE
    perfume: 'https://i.ibb.co/BRk8KzT/unnamed-12.jpg',        // NOUVELLE
    travel: 'https://i.ibb.co/BRk8KzT/unnamed-12.jpg',         // NOUVELLE (même que perfume)
...
function hideLoadingInstantly() {
    ...
    console.log('✅ Quiz affiché immédiatement');
}

/* ============================================
   5. QUIZ PSYCHOLOGUE - QUESTIONS PROFONDES
   ============================================ */
class QuizManager {
    constructor() {
        this.currentQuestion = 0;
        
        // QUESTIONS PSYCHOLOGIQUES PROFONDES
        this.questions = [
            {
